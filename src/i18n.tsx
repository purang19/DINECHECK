...
const en: Dict = {
  ...
  'select.hotel': 'Select a hotel...',
  'select.restaurant': 'Select an outlet...',
  ...
  'rating.drinkQuality': 'Drink Quality',
  'rating.drinkFlavorBalance': 'Drink Flavor & Balance',
  'rating.responseTime': 'Response Time',
  'beverage.title': 'Beverage Quality',
  'beverage.add': '+ ADD A DRINK',
  'placeholder.beverage': 'e.g. Mango Smoothie',
  'item.beverageName': 'Drink Name {n}',
  'kpi.beverage': 'Beverage',
  'err.beverageRatings': 'Please complete all Beverage ratings for {item}.',
  ...
  'dash.allHotels': 'All hotels',
  'dash.byHotel': 'Average by Hotel',
  'dash.byRestaurant': 'Average by Outlet',
...
const th: Dict = {
  ...
  'rating.drinkQuality': 'คุณภาพเครื่องดื่ม',
  'rating.drinkFlavorBalance': 'รสชาติและความสมดุลของเครื่องดื่ม',
  'rating.responseTime': 'ความรวดเร็วในการเสิร์ฟ',
  'beverage.title': 'คุณภาพเครื่องดื่ม',
  'beverage.add': '+ เพิ่มเครื่องดื่ม',
  'placeholder.beverage': 'เช่น สมูทตี้มะม่วง',
  'item.beverageName': 'ชื่อเครื่องดื่มที่ {n}',
  'kpi.beverage': 'เครื่องดื่ม',
  'err.beverageRatings': 'กรุณาให้คะแนนเครื่องดื่มให้ครบสำหรับ {item}',
  ...
  'dash.allHotels': 'ทุกโรงแรม',
  'dash.byHotel': 'ค่าเฉลี่ยตามโรงแรม',
